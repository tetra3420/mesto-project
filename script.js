const editProfileButton = document.querySelector('.profile__bt-edit');
...
const addButton = document.querySelector('.profile__bt-add');
...
elementAdded.querySelector('.element__image').setAttribute('src', imageValue);;
